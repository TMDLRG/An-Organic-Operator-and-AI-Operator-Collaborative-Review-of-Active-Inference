...
**Draft status.** Second full draft (v2). This is a *reviewable working document*, not a final scientific authority. It has not been peer-reviewed by qualified human experts. Every mathematical conclusion is offered for expert correction. Phases P0–P3 of the [Audit Remediation Plan](Audit_Remediation_Plan.md) have been applied; Phase P4 (this draft) production preserves the v1 historical record and applies 27 documented patches. Layer 2 (human expert review) gates remain pending — see [Layer2_Inspection_Specs.md](Layer2_Inspection_Specs.md) and [Pre_Publication_Checklist.md](Pre_Publication_Checklist.md).
