  ...
  return (
    <div className="max-w-screen-2xl mx-auto px-6 py-8 w-full">
      ...
      <p className="text-muted text-sm mb-4 max-w-3xl">
        ...
        browser-first reference; an OTP/BEAM implementation in <strong>Jido</strong> (Elixir) lives in
      ...
      <div className="mb-6 border border-border rounded-lg bg-card p-4 max-w-3xl">
        <div className="text-xs uppercase tracking-wider text-muted mb-2">Implementation references</div>
        <div className="flex flex-wrap gap-x-4 gap-y-2 text-xs">
          <a href="/docs/AGENTS.md" className="text-accent underline">AGENTS.md (binding policy)</a>
          <span className="text-muted">·</span>
          <a href="/docs/ui/agents-elixir/lib/aoaiop_agents/discrete_agent.ex" className="text-accent underline font-mono">discrete_agent.ex (Jido)</a>
          <span className="text-muted">·</span>
          <a href="/docs/ui/agents-elixir/lib/aoaiop_agents/gaussian_agent.ex" className="text-accent underline font-mono">gaussian_agent.ex (Jido)</a>
          <span className="text-muted">·</span>
          <a href="/docs/ui/agents-elixir/test/discrete_agent_test.exs" className="text-accent underline font-mono">ExUnit tests</a>
          <span className="text-muted">·</span>
          <a href="/docs/ui/lib/agents.ts" className="text-accent underline font-mono">agents.ts (TypeScript reference)</a>
          <span className="text-muted">·</span>
          <a href="/docs/ui/agents-elixir/mix.exs" className="text-accent underline font-mono">mix.exs</a>
        </div>
      </div>
